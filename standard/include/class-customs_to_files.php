	...
	*/
	class suppa_customs2files
	{
		...
		function save_to_files( $location_info )
		{
			...
			/** Get Options From Json File **/
			$json_file 		=	$skins_folder . $location_info[1] . '.json';
			$handle 		= 	@fopen($json_file, 'r');
			$json_data 		= 	@fread($handle,filesize($json_file));
								@fclose($handle);
            ...
            {
                $menu_background    = 'background-image:url(\''. $skin_data['menu_bg_bg_image'].'\') !important;
            ...
            {
                $submenu_background_image = 'background-image:url(\''. $skin_data['submenu-bg_bg_image'].'\') !important;
            ...
            '
                ...
                .'.$location_info[0].' .suppa_menu_logo img{
                    padding : '.$skin_data['title-padding_top'].' '.$skin_data['title-padding_right'].' 0px '.$skin_data['title-padding_left'].' !important;
                }
                .'.$location_info[0].' .suppa_menu_logo {
                    height:'.$skin_data['menu_height'].';
                ...
                .'.$location_info[0].' .suppa_menu_woocommerce_cart > a {
                ...
                .'.$location_info[0].' .suppa_menu_woocommerce_cart .suppa_item_title {
                    font-size:'.$skin_data['top_level_font_font_size'].'px !important;
                    font-family:'.$skin_data['top_level_font_font_family'].' !important;
                    '.$skin_data['top_level_font_font_family_style'].'
                    color:'.$skin_data['top_level_font_font_color'].';

                    padding-top:'.$skin_data['top_level_padding_top'].' !important;
                ...
                .'.$location_info[0].' .suppa_menu_woocommerce_cart a{
                    ...
                    border-color:'.$skin_data['top-links-border_color'].' !important;
                }
                ...
                .'.$location_info[0].' .suppa_menu_woocommerce_cart:hover a{
                ...
                .'.$location_info[0].' .suppa_menu_woocommerce_cart.suppa_menu_class_hover a {
                    background-color:'.$skin_data['top_level_bg_hover'].' !important;
                    color:'.$skin_data['top_level_links_color_hover'].' !important;
                }
                .'.$location_info[0].' .suppa_menu.suppa_menu_class_hover .suppa_top_level_link .suppa_item_title,
                .'.$location_info[0].' .suppa_menu_woocommerce_cart.suppa_menu_class_hover .suppa_item_title {
                    color:'.$skin_data['top_level_links_color_hover'].' !important;
                }
                ...
                .'.$location_info[0].' .suppa_menu_woocommerce_cart .suppa_menu_position_left {
                ...
                .'.$location_info[0].' .suppa_menu_woocommerce_cart .suppa_menu_position_right {
                ...
                .'.$location_info[0].' .suppa_menu_woocommerce_cart a .ctf_suppa_fa_box_top_arrow{
                ...
                .'.$location_info[0].' .suppa_menu_woocommerce_cart a .ctf_suppa_fa_box{
                    color:'.$skin_data['top-links-arrow_color_hover'].' !important;
                }
                ...
                .'.$location_info[0].' .suppa_menu_woocommerce_cart:hover a .ctf_suppa_fa_box{
                    color:'.$skin_data['top_level_links_color_hover'].';
                }
                .'.$location_info[0].' .suppa_menu .suppa_top_level_link .ctf_suppa_fa_box,
                .'.$location_info[0].' .suppa_menu_woocommerce_cart a .ctf_suppa_fa_box{
                ...
                .'.$location_info[0].' .suppa_post {
                    ...
                    .'.$location_info[0].' .suppa_post div.suppa_post_link_container {
                        background-color: '.$skin_data['latest_posts_link_bg_color'].' !important ;
                    }
                    .'.$location_info[0].' .suppa_post span {
                        ...
                        .'.$location_info[0].' .suppa_post span:hover {
                            /* color/bg/border */
                            color:'.$skin_data['submenu-posts-post_link_color_hover'].' !important;
                        }
                    ...
                    .'.$location_info[0].' .suppa_latest_posts_view_all{
                        ...
                        background-color: '.$skin_data['latest_posts_view_all_bg'].' !important ;
                    }

                    .'.$location_info[0].' .suppa_latest_posts_view_all:hover{
                        /* color/bg/border */
                        color:'.$skin_data['latest_posts_view_all_color_hover'].';
                        background-color: '.$skin_data['latest_posts_view_all_bg_hover'].' !important ;
                    }
                ...
                /** Needed for suppa_frontend.js **/
                .'.$location_info[0].' .suppa_menu_class_dropdown_levels_hover > a {
                    color:'.$skin_data['submenu-dropdown-link_color_hover'].' !important;
                    background-color:'.$skin_data['submenu_dropdown_link_bg_hover'].' !important;
                }
                .'.$location_info[0].' .suppa_menu_class_dropdown_levels_hover > a .suppa_item_title{
                    color:'.$skin_data['submenu-dropdown-link_color_hover'].' !important;
                }
                ...
                .'.$location_info[0].' .suppa_menu_search .suppa_search_form {
                ...
                .'.$location_info[0].' .suppa_rwd_menu_search {
                    background-color:'.$skin_data['submenu-search-input_bg_color'].' !important;
                }

                .'.$location_info[0].' .suppa_menu_search .suppa_search_form .suppa_search_input,
                .'.$location_info[0].' .suppa_rwd_menu_search .suppa_search_form .suppa_search_input{
                        width:'.$skin_data['submenu-search-input_width'].';
                        height:'.$skin_data['submenu-search-input_height'].';
                        line-height:'.$skin_data['submenu-search-input_height'].' !important;

                        font-size:'.$skin_data['submenu-search-text_font_font_size'].'px;
                        font-family:'.$skin_data['submenu-search-text_font_font_family'].' !important;
                        '.$skin_data['submenu-search-text_font_font_family_style'].'

                        padding-right:'.$skin_data['submenu-search-text_padding_right'].' !important;
                        padding-left:'.$skin_data['submenu-search-text_padding_left'].' !important;

                        /* color/bg/border */
                        background-color:'.$skin_data['submenu-search-input_bg_color'].' !important;
                        color:'.$skin_data['submenu-search-text_font_font_color'].' !important;

                        -moz-border-radius: '.$skin_data['submenu-search-input-borderradius_top_left'].' '.$skin_data['submenu-search-input-borderradius_top_right'].' '.$skin_data['submenu-search-input-borderradius_bottom_right'].' '.$skin_data['submenu-search-input-borderradius_bottom_left'].';
                        -webkit-border-radius: '.$skin_data['submenu-search-input-borderradius_top_left'].' '.$skin_data['submenu-search-input-borderradius_top_right'].' '.$skin_data['submenu-search-input-borderradius_bottom_right'].' '.$skin_data['submenu-search-input-borderradius_bottom_left'].';
                        border-radius: '.$skin_data['submenu-search-input-borderradius_top_left'].' '.$skin_data['submenu-search-input-borderradius_top_right'].' '.$skin_data['submenu-search-input-borderradius_bottom_right'].' '.$skin_data['submenu-search-input-borderradius_bottom_left'].';
                ...
                .'.$location_info[0].' .suppa_search_input::-webkit-input-placeholder {
                   color:'.$skin_data['submenu-search-text_font_font_color'].' !important;
                }

                .'.$location_info[0].' .suppa_search_input:-moz-placeholder { /* Firefox 18- */
                   color:'.$skin_data['submenu-search-text_font_font_color'].' !important;
                }

                .'.$location_info[0].' .suppa_search_input::-moz-placeholder {  /* Firefox 19+ */
                   color:'.$skin_data['submenu-search-text_font_font_color'].' !important;
                }

                .'.$location_info[0].' .suppa_search_input:-ms-input-placeholder {
                   color:'.$skin_data['submenu-search-text_font_font_color'].' !important;
                }

                .'.$location_info[0].' .suppa_menu_search .suppa_search_icon ,
                .'.$location_info[0].' .suppa_rwd_menu_search .suppa_search_icon{
                    line-height:'.( (int)$skin_data['menu_height'] - (int)$skin_data['submenu-search_margin_top'] - (int)$skin_data['menu_border_bottom_size'] - (int)$skin_data['menu_border_top_size'] ).'px !important;

                    padding-top:'.$skin_data['submenu-search_margin_top'].' ;
                    padding-left:'.$skin_data['submenu-search_margin_left'].' ;
                    padding-right:'.$skin_data['submenu-search_margin_right'].' ;
                    color:'.$skin_data['submenu-search-button_icon_color'].';

                }

                .'.$location_info[0].' .suppa_menu_search:hover .suppa_search_icon,
                .'.$location_info[0].' .suppa_menu_search .suppa_search_icon:hover ,
                .'.$location_info[0].' .suppa_rwd_menu_search .suppa_search_icon:hover,
                .'.$location_info[0].' .suppa_menu_search .suppa_search_icon_ClassHover{
                    color:'.$skin_data['submenu-search-button_color_hover'].' !important;
                    background-color:'.$skin_data['submenu-search-button_bg_color'].' !important;
                }

                .'.$location_info[0].' .suppa_menu_search .suppa_search_icon,
                .'.$location_info[0].' .suppa_rwd_menu_search .suppa_search_icon{
                    font-size : '.$skin_data['submenu-search-button_icon_size'].';
                }

                .'.$location_info[0].' .suppa_menu_search .suppa_search_form_big {
                    z-index : '.( (int)$skin_data['menu_z_index'] + 50 ).' !important;
                }
                .'.$location_info[0].' .suppa_menu_search .suppa_search_form_big,
                .'.$location_info[0].' .suppa_menu_search .suppa_search_form_big input{
                    width:'.$skin_data['menu_width'].' !important;
                }
                ...
                .'.$location_info[0].' .suppa_menu_search .suppa_search_form_big input,
                .'.$location_info[0].' .suppa_search_form_big .suppa_search_icon_remove{
                    font-size:'.( (int)$skin_data['submenu-search-text_font_font_size'] * 1.5 ).'px !important;
                }
                ...
                .'.$location_info[0].' .suppa_rwd_button span{
                    ...
                    color:'.$skin_data['rwd_3bars_icon_color'].' !important;
                }
                .'.$location_info[0].' .suppa_rwd_text{
                ...
                /* Logo */
                .'.$location_info[0].' .suppa_rwd_logo{
                    height:'.$skin_data['menu_height'].';
                }
                .'.$location_info[0].' .suppa_rwd_logo img{
                    padding : '.$skin_data['rwd_logo_padding_top'].' '.$skin_data['rwd_logo_padding_right'].' 0px '.$skin_data['rwd_logo_padding_left'].' !important;
                }
                ...
                .'.$location_info[0].' .suppa_rwd_menu_search form {
                    padding-top:'.$skin_data['rwd_submenu_padding_top'].' !important;
                    padding-bottom:'.$skin_data['rwd_submenu_padding_bottom'].' !important;
                    padding-right:'.$skin_data['rwd_submenu_padding_right'].' !important;
                    padding-left:'.$skin_data['rwd_submenu_padding_left'].' !important;
                }
                .'.$location_info[0].' .suppa_rwd_menu_search form input[type="text"]{
                    color:'.$skin_data['submenu-search-text_font_font_color'].' !important;
                }
            ...
            suppa_js_settings.jquery_mode       = '".$skin_data['settings-jquery_enable']."';
            ...
            suppa_js_settings.rwd_enable_desk   = '".$skin_data['settings-responsive_enable_desktops']."';
