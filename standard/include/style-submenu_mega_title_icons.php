<?php
echo '<h3 class="ctf_page_title">' . __('"Mega Links" Title Icon','suppa_menu') . '</h3>';

// FontAwesome Icons Size
$this->add_text_input(
	array(
		'group_id'			=> 'style', 		
		'option_id'			=> 'submenu_mega_title_fontawesome_icons_size', 		
...
echo 	'<div class="ctf_option_container suppa_all_op_container">
			...
			$this->add_text_input(
				array(
					'group_id'			=> 'style', 		
					'option_id'			=> 'submenu_mega_title_fontawesome_icon_margin_top', 		
					'value'				=> '13px', 		 				
			...
			$this->add_text_input(
				array(
					'group_id'			=> 'style', 		
					'option_id'			=> 'submenu_mega_title_fontawesome_icon_margin_right', 		
					'value'				=> '10px', 		
					'class'				=> 'ctf_option_gradient'
				),
				'ctf_container_gradient'
...
echo 	'<div class="ctf_option_container suppa_all_op_container">
			...
			$this->add_text_input(
				array(
					'group_id'			=> 'style', 		
					'option_id'			=> 'submenu_mega_title_uploaded_icons_width', 		
					'value'				=> '13px', 		 				
					'class'				=> 'ctf_option_gradient'
				),
				'ctf_container_gradient'
			...
			$this->add_text_input(
				array(
					'group_id'			=> 'style', 		
					'option_id'			=> 'submenu_mega_title_uploaded_icons_height', 		
					'value'				=> '13px', 		
					'class'				=> 'ctf_option_gradient'
				),
				'ctf_container_gradient'
...
echo 	'<div class="ctf_option_container suppa_all_op_container">
			...
			$this->add_text_input(
				array(
					'group_id'			=> 'style', 		
					'option_id'			=> 'submenu_mega_title_normal_icon_margin_top', 		
					'value'				=> '8px', 		 				
					'class'				=> 'ctf_option_gradient'
				),
				'ctf_container_gradient'
			...
			$this->add_text_input(
				array(
					'group_id'			=> 'style', 		
					'option_id'			=> 'submenu_mega_title_normal_icon_margin_right', 		
					'value'				=> '10px', 		
					'class'				=> 'ctf_option_gradient'
				),
				'ctf_container_gradient'
