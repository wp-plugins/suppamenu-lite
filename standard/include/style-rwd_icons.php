...
echo '<h3 class="ctf_page_title">' . __('Responsive Icons','suppa_menu') . '</h3>';
...
$this->add_text_input(
	array(
		'group_id'			=> 'style', 		
		'option_id'			=> 'rwd_links_fontawesome_icons_size', 		
...
echo 	'<div class="ctf_option_container suppa_all_op_container">
			...
			$this->add_text_input(
				array(
					'group_id'			=> 'style', 		
					'option_id'			=> 'rwd_links_fontawesome_icon_margin_top', 		
					'value'				=> '10px', 		 				
			...
			$this->add_text_input(
				array(
					'group_id'			=> 'style', 		
					'option_id'			=> 'rwd_links_fontawesome_icon_margin_right', 		
					'value'				=> '10px', 		
					'class'				=> 'ctf_option_gradient'
				),
				'ctf_container_gradient'
...
echo 	'<div class="ctf_option_container suppa_all_op_container">
			...
			$this->add_text_input(
				array(
					'group_id'			=> 'style', 		
					'option_id'			=> 'rwd_links_uploaded_icons_width', 		
					'value'				=> '14px', 		 				
					'class'				=> 'ctf_option_gradient'
				),
				'ctf_container_gradient'
			...
			$this->add_text_input(
				array(
					'group_id'			=> 'style', 		
					'option_id'			=> 'rwd_links_uploaded_icons_height', 		
					'value'				=> '14px', 		
					'class'				=> 'ctf_option_gradient'
				),
				'ctf_container_gradient'
...
echo 	'<div class="ctf_option_container suppa_all_op_container">
			...
			$this->add_text_input(
				array(
					'group_id'			=> 'style', 		
					'option_id'			=> 'rwd_links_normal_icon_margin_top', 		
					'value'				=> '10px', 		 				
					'class'				=> 'ctf_option_gradient'
				),
				'ctf_container_gradient'
			...
			$this->add_text_input(
				array(
					'group_id'			=> 'style', 		
					'option_id'			=> 'rwd_links_normal_icon_margin_right', 		
					'value'				=> '10px', 		
					'class'				=> 'ctf_option_gradient'
				),
				'ctf_container_gradient'
